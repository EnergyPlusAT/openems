package io.openems.edge.meter.carlo.gavazzi.em500;
...
@Component(//
		name = "Meter.CarloGavazzi.EM500", //
		immediate = true, //
		configurationPolicy = ConfigurationPolicy.REQUIRE //
)
public class MeterCarloGavazziEm500Impl extends AbstractOpenemsModbusComponent
		implements MeterCarloGavazziEm500, SymmetricMeter, AsymmetricMeter, ModbusComponent, OpenemsComponent {
	...
	public MeterCarloGavazziEm500Impl() {
		super(//
				OpenemsComponent.ChannelId.values(), //
				ModbusComponent.ChannelId.values(), //
				SymmetricMeter.ChannelId.values(), //
				AsymmetricMeter.ChannelId.values(), //
				MeterCarloGavazziEm500.ChannelId.values() //
		);
	}
		...
		return new ModbusProtocol(this, //
				...
				new FC4ReadInputRegistersTask(300013 - offset, Priority.HIGH, //
						...
						m(AsymmetricMeter.ChannelId.ACTIVE_POWER_L3,
								...
								ElementToChannelConverter
										.SCALE_FACTOR_MINUS_1_AND_INVERT_IF_TRUE(this.config.invert())),
						m(MeterCarloGavazziEm500.ChannelId.APPARENT_POWER_L1,
								new SignedDoublewordElement(300025 - offset).wordOrder(WordOrder.LSWMSW),
								ElementToChannelConverter
										.SCALE_FACTOR_MINUS_1_AND_INVERT_IF_TRUE(this.config.invert())),
						m(MeterCarloGavazziEm500.ChannelId.APPARENT_POWER_L2,
								new SignedDoublewordElement(300027 - offset).wordOrder(WordOrder.LSWMSW),
								ElementToChannelConverter
										.SCALE_FACTOR_MINUS_1_AND_INVERT_IF_TRUE(this.config.invert())),
						m(MeterCarloGavazziEm500.ChannelId.APPARENT_POWER_L3,
						...
						m(SymmetricMeter.ChannelId.ACTIVE_POWER,
								...
								ElementToChannelConverter
										.SCALE_FACTOR_MINUS_1_AND_INVERT_IF_TRUE(this.config.invert())),
						m(MeterCarloGavazziEm500.ChannelId.APPARENT_POWER,
